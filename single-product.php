...
<html lang="en">
  ...
  <body>
    ...
    <section class="site-banner padding-small bg-primary">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
    ...
    <div class="main-content d-flex flex-wrap padding-large">
      ...
      <?php
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $output .= "<div class='feature-image'>";
            $output .= "<img src='" . $row['p_img'] . "' alt='post image' class='jarallax-img'>";
            $output .= "</div>";
            $output .= "</div>";
            $output .= "<div class='col-md-6'>";
            $output .= "<h1 class='page-title'>" . $row['p_name'] . "</h1>";
            $output .= "<p>" . $row['p_descrip'] . "</p>";
            $output .= "<h2 class='item-price text-primary'>฿ " . $row['p_price'] . "</h2>";
            $output .= "<p class='inputnum'>";
            $output .= "<p>Quantity: </p><input type='number' step='1' min='0' max='10' value='1' name='quantity' class='quantity-field border-0 text-center w-25'></p>";

            $output .= "<div class='post-tags'>";
            $output .= "<div class='block-tag'>";
            $output .= "<ul class='list-unstyled d-flex'>";
            $output .= "<li>";
            $output .= "<a href='#' class='btn btn-dark btn-l btn-rounded'>Add to Cart</a>";
            $output .= "</li>";
            $output .= "</ul>";
            $output .= "</div>";
            $output .= "</div>";
